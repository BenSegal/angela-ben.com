...
*/
$( function() {
        var wedding = "February 20, 2022 16:00:00";

        $('.countdown.simple').countdown({ date: wedding });

        $('.countdown.styled').countdown({
          date: wedding,
          render: function(data) {
            $(this.el).html("<div>" + this.leadingZeros(data.years * 365 + data.days, 2) + " <span>days</span></div><div>" + this.leadingZeros(data.hours, 2) + " <span>hrs</span></div><div>" + this.leadingZeros(data.min, 2) + " <span>min</span></div><div>" + this.leadingZeros(data.sec, 2) + " <span>sec</span></div>");
          }
        });
